...
function switchTab(tab) {
    ...
    document.getElementById('nav-master').className = tab === 'master' ? "w-full px-4 py-3 rounded-xl flex items-center gap-3 bg-purple-600 text-white shadow-lg shadow-purple-600/20" : "w-full px-4 py-3 rounded-xl flex items-center gap-3 text-gray-400 hover:bg-white/5 hover:text-white transition";
    document.getElementById('nav-outreach').className = tab === 'outreach' ? "w-full px-4 py-3 rounded-xl flex items-center gap-3 bg-purple-600 text-white shadow-lg shadow-purple-600/20" : "w-full px-4 py-3 rounded-xl flex items-center gap-3 text-gray-400 hover:bg-white/5 hover:text-white transition";
}
